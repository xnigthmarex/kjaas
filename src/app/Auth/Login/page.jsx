...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    function setSessionCookie(cookieName, cookieValue, expirationTime) {
      var date = new Date();
      date.setTime(date.getTime() + expirationTime * 1000); // Convert expirationTime to milliseconds
    ...
    //make call to the /api/login route to check  if the user exists use axios
    try {
